...
final class AudioRecorder: NSObject, ObservableObject, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    private let sessionQueue = DispatchQueue(label: "com.openspeech.app.capture.session")
    private let sampleBufferQueue = DispatchQueue(label: "com.openspeech.app.capture.samples")
