...
private let realtimeLog = OSLog(subsystem: "com.openspeech.app", category: "RealtimeTranscription")
...
final class RealtimeTranscriptionService {
    ...
    private let stateQueue = DispatchQueue(label: "com.openspeech.app.realtime.state")
